...
router.post('/comment/:id', passport.authenticate('jwt', {session: false}, (res,res) => {
...
router.delete('/comment/:id/:comment_id', passport.authenticate('jwt', {session: false}, (res,res) => {
    Post.findById(req.params.id)
    .then(post => {
